...
// let resultado;
// let numeroUno = parseFloat (prompt ("denme su primer numero"));
// let operadores = prompt ("ponga su operador");
// let numeroDos = parseFloat (prompt ("ingrese su segundo numero"));
...
// calculadora(numeroUno, operadores, numeroDos);
...
// const baratos = productos.filter(producto => producto.precio < 70);
// console.log(baratos);
